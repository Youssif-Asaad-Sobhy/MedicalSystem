...
namespace Medical_System.Controllers
{
    ...
    public class Test : ControllerBase
    {
        ...
        [HttpGet("paginated")]
        public async Task<IActionResult> GetAllTestAsync([FromQuery] string[]? filter, [FromQuery] PageFilter? pageFilter, [FromQuery] string? search = null)
        {
            var response = await _service.GetAllTestAsync(filter, pageFilter, search);
            return Ok(response);
        }
        #endregion
    }
