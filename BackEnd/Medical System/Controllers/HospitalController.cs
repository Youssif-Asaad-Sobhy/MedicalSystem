...
namespace Medical_System.Controllers
{
    ...
    public class HospitalController : ControllerBase
    {
        ...
        [HttpGet("paginated")]
        public async Task<IActionResult> GetAllHospitalsAsync([FromQuery] string[]? filter, [FromQuery] PageFilter? pageFilter, [FromQuery] string? search = null)
        {
            var response = await _service.GetAllHospitalAsync(filter, pageFilter, search);
            return Ok(response);
        }
        #endregion
    }
