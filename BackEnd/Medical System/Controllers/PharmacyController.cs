...
namespace Medical_System.Controllers
{
    ...
    public class PharmacyController : ControllerBase
    {
        ...
        [HttpGet("paginated")]
        public async Task<IActionResult> GetAllPharmacyAsync([FromQuery] string[]? filter, [FromQuery] PageFilter? pageFilter, [FromQuery] string? search = null)
        {
            var response = await _service.GetAllPharmacyAsync(filter, pageFilter, search);
            return Ok(response);
        }
        #endregion
    }
